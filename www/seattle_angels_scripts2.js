...
function viewMoreDetail(whichPage)
{
	...
	switch (whereAmI)
	{
		case USER_SEES_COMPANY_BRIEFS: 		whereAmI = USER_SEES_COMPANY_DETAILS; 		console.log("Q!"); break;
		case USER_SEES_COMPANY_DETAILS: 	whereAmI = USER_SEES_COMPANY_DETAILS;  		console.log("Q@"); break;
		case USER_SEES_ENTREPRENEUR_BRIEFS: whereAmI = USER_SEES_ENTREPRENEUR_BRIEFS;  	console.log("Q#"); break;
		case USER_SEES_INVESTOR_BRIEFS:		whereAmI = USER_SEES_INVESTOR_BRIEFS;  		console.log("Q$"); break;
		case USER_SEES_MESSAGE_FROM_JOHN:	whereAmI = USER_SEES_OUTER_NAVIGATION; 		console.log("Q%"); break;
		case USER_SEES_OUTER_NAVIGATION: 	
			switch (document.getElementById('theswipelist').selected)
			{
				case 0: whereAmI = USER_SEES_COMPANY_BRIEFS;		console.log("Q^"); break;
				case 1:	whereAmI = USER_SEES_ENTREPRENEUR_BRIEFS;	console.log("Q&"); break;
				case 2:	whereAmI = USER_SEES_INVESTOR_BRIEFS;		console.log("Q*"); break;
				default: throw "Unexpected Value for \"document.getElementById('theswipelist').selected\"" 
			}
			break;
		default: throw "Unexpected Value for \"whereAmI\""
	}
...
function displayPage(whichPage)
{
	...
	switch(whereAmI)
	{
		case USER_SEES_COMPANY_DETAILS: 	calcS = companyDetailsHTML; 	console.log("J!"); break;
		case USER_SEES_COMPANY_BRIEFS: 		calcS = companyBriefsHTML;		console.log("J@"); break;
		case USER_SEES_OUTER_NAVIGATION: 	calcS = outerNavigationHTML;	console.log("J#"); break;
		case USER_SEES_ENTREPRENEUR_BRIEFS:	calcS = entrepreneurBriefsHTML; console.log("J$"); break;
		case USER_SEES_INVESTOR_BRIEFS:		calcS = investorBriefsHTML;		console.log("J%"); break;
		case USER_SEES_MESSAGE_FROM_JOHN:	calcS = messageFromJohnHTML;	console.log("J^"); break;
	}
...
function createSwipePagesHTML(databaseReply)
{
	...
	companyDetailsHTML 		= 	"<swipe-pages id=\"theswipelist\" selected=\"0\" transitionDuration=\"0.3\" class=\"unusedClass\">" 
	companyBriefsHTML 		= 	"<swipe-pages id=\"theswipelist\" selected=\"0\" transitionDuration=\"0.3\" class=\"unusedClass\">"
	entrepreneurBriefsHTML 	= 	"<swipe-pages id=\"theswipelist\" selected=\"0\" transitionDuration=\"0.3\" class=\"unusedClass\">"
